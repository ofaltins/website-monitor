const monitors = [
    {
        ...
        preStep: async (page) => {
            const cookieAcceptButtonSelector = '#template > div > div > section > button.privacy.accept'
            const isPresent = (await page.$(cookieAcceptButtonSelector)) || false;
            if (isPresent) {
                await page.click("#template > div > div > section > button.privacy.accept");
            }
        },
        element: "#grid-outboundF0 > td.col-md-2.col-sm-2.col-xs-2.slide-business.up-grid-prods > div > span.fareprice-bold-ubc > p",
    ...
    },
    {
        ...
        element: "#productCardContent > table > tbody > tr > td:nth-child(2) > div.b-price-block.b-price-block_visible > div.b-prod-price > span.pricedetails",
        validate: async (content) => {
